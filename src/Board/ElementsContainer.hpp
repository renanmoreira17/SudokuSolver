...
public:
    ...
    iterator begin()
    {
        return iterator(&m_elements[0][0]);
    }
    iterator end()
    {
        return iterator(&m_elements[R-1][C-1] + 1);
    }
    const_iterator cbegin() const
    {
        return const_iterator((T *)&m_elements[0][0]);
    }
    const_iterator cend() const
    {
        return const_iterator((T *)&(m_elements[R-1][C-1]) + 1);
    }
    ...
    T &operator()(TileValueType row, TileValueType col)
    {
